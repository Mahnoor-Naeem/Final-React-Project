              ...
              >
                <ul className="navbar-nav ml-auto">
                  ...
                  <li className="nav-item">
                    <NavLink activeClassName="menu_active" exact className="nav-link" to="/mealrecipe">
                      Meal. Recipe
                    </NavLink>
                  </li>
                  <li className="nav-item">
                    <NavLink activeClassName="menu_active" exact className="nav-link" to="/mealplanner">
                      Meal. Planner
                    </NavLink>
                  </li>
                  <li className="nav-item">
